/****************************************************************************
** Meta object code from reading C++ file 'gameboard.hh'
**
...
#error "The header file 'gameboard.hh' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 10), // "mouseClick"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 1), // "x"
QT_MOC_LITERAL(4, 24, 1) // "y"

    },
    "GameBoard\0mouseClick\0\0x\0y"
};
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GameBoard::*_t)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameBoard::mouseClick)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject GameBoard::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_GameBoard.data,
...
// SIGNAL 0
void GameBoard::mouseClick(int _t1, int _t2)
{
