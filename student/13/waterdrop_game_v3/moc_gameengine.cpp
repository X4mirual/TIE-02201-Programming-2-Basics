/****************************************************************************
** Meta object code from reading C++ file 'gameengine.hh'
**
...
#error "The header file 'gameengine.hh' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 21, 8), // "addWater"
QT_MOC_LITERAL(4, 30, 1), // "x"
QT_MOC_LITERAL(5, 32, 1) // "y"

    },
    "GameEngine\0quitGame\0\0addWater\0x\0y"
};
...
void GameEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addWater((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameEngine::quitGame)) {
                *result = 0;
                return;
            }
        }
